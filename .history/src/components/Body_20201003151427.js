    ...
    return(
        <>
            <div className="hobby-section">
                ...
                <div className="hobbies-container">
                    <img src={illo} className="illo" alt="illustration"/>
                    <div className="mini-cards card">
                        <Accordion title="Traveling" content="I love to travel"/>
                        <Accordion title="Hiking" content="I love to hike"/>
                        <Accordion title="Volunteering" content="I love to travel"/>
                        <Accordion title="Designing" content="I love to travel"/>
                    </div>
                </div>
            </div>
        </>
