...
const AboutMe = () => {
    let bio = "I’m a self-taught graphic designer & web developer from Sacramento, CA. My creativity is fueled by coffee and good conversations. I am transitioning into the Computer Science field because I am powered by problem-solving and I love watching the code turn into "
    return(
        <>
