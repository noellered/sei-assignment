...
const HobbiesAlt = () => {
    ...
    let travelContent = "I have been fortunate enough to have traveled often throughout my life. Traveling fills my soul like nothing else. I love talking to So far, my favorite destinations have been Koh Samui, TH, Osaka, JP, and Amsterdam, NL";
    let hikeContent = "";
