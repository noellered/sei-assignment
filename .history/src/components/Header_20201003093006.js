        ...
        <>
            <div className="card">
                ...
                <div className="">
                    ...
                    <p><img src={phoneicon} className="icon-small" alt="phone icon"/> {phone}</p>
                    <br/>
                    
                    <p><img src={emailicon} className="icon-small" alt="email icon"/> {email}</p>
                    <br/>
                    
                    <p><img src={githubicon} className="icon-small" alt="github icon"/> {github}</p>
                </div>
            </div>
        </>
    )
