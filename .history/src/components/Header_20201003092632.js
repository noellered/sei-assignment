...
import emailiucon from '../assets/email.svg';
    ...
    return(
        <>
            <div className="card">
                <h1>Get in touch!</h1>
                <div className="icon-container">
                    <img src={phone} className="icon-small" alt="phone icon"/>
                    <img src={email} className="icon-small" alt="email icon"/>
                    <img src={github} className="icon-small" alt="github icon"/>
                </div>
            </div>
        </>
    )
