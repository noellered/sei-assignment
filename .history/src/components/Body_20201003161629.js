...
const HobbiesAlt = () => {
    ...
    let hikeContent = "Getting outside is the best way to clear your head. I always enjoy a great hike through the Sierra Nevadas and of course a night under the stars.";
