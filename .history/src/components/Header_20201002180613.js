                    ...
                    <h1>Favorite Tools</h1>
                        <p class="subheader">Creative</p>
                            ...
                            <div class="icon-container">
                                <img src={photoshop} className="photoshop-logo" alt="photoshop logo"/>
                                <img src={illustrator} className="illustrator-logo" alt="illustrator logo"/>
                                <img src={indesign} className="photoshop-logo" alt="photoshoplogo"/>
                                <img src={photoshop} className="photoshop-logo" alt="photoshoplogo"/>
                            </div>
