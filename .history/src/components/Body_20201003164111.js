        ...
        <>
            <div className="hobby-section">
                ...
                <div className="hobbies-container">
                    <img src={illo} className="illo" alt="illustration" />
                    <div className="list">
                        <Accordion title="Traveling" content={travelContent} image={tokyo}/>
                        <Accordion title="Hiking" content={hikeContent} image={hiking}/>
                        <Accordion title="Volunteering" content={volunteerContent} image={volunteer}/>
                        <Accordion title="Designing" content={designContent} image={design}/>
                    </div>
                </div>
            </div>
        </>
