...
const AboutMe = () => {
    let bio = "I’m a self-taught graphic designer & web developer from Sacramento, CA. I found my passion for Computer Science, and since January 2020 that passion has only grown stronger. I and am now transitioning into the field because I am powered by problem-solving and I love bringing code to life."
    return(
        <>
