...
const HobbiesAlt = () => {
    ...
    let designContent = "Sometimes I just need to let my creativity flow, and that's when I'll hop on my the computer or iPad and let loose. You can check out some of my design work at ";
