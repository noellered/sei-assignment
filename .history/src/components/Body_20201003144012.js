        ...
        <>
            <div className="hobby-section">
                ...
                <div className="hobbies-container">
                    ...
                    <Accordion atomic={true} className="mini-cards">
                        <AccordionItem title="Traveling" className="card hobby">
                            <p>Description of Traveling because that's cool</p>
                        </AccordionItem>
                        <AccordionItem title="Hiking" className="card hobby">
                            <p>Description of Traveling because that's cool</p>
                        </AccordionItem>
                        <AccordionItem title="Volunteering" className="card hobby">
                            <p>Description of Traveling because that's cool</p>
                        </AccordionItem>
                        <AccordionItem title="Designing" className="card hobby">
                            <p>Description of Traveling because that's cool</p>
                        </AccordionItem>
                    </Accordion>
                </div>
